<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorAdd.aspx.cs" Inherits="WeiXinYiShengCollege.WebSite.jqueryweui.wx.DoctorAdd" %>
...
<body ontouchstart>
    ...
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" type="text" value="" id="txtName" placeholder="请填写姓名">
            </div>
        </div>
    ...
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell">
            <div class="weui-cell__bd">
                <textarea class="weui-textarea" placeholder="请添加简介" rows="10" id="txtRemark"></textarea>
