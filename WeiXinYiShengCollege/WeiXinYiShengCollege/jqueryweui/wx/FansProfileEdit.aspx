<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FansProfileEdit.aspx.cs" Inherits="WeiXinYiShengCollege.WebSite.jqueryweui.wx.FansProfileEdit" %>
...
<body ontouchstart>
    ...
    <header class='demos-header'>
        <h1 class="demos-title">个人信息修改</h1>
    </header>
    ...
    <div class="weui-cells__tips">描述:请完成相关信息修改</div>
    ...
    <script>
        $("#showTooltips").click(function () {
            ...
            $.ajax({
                ...
                data: { Action: "UpdateFansInfo",OpenId:OpenId, mobile: mobile, nickname: nickname, r: Math.random() },
                dataType: "json",
                async: true,
